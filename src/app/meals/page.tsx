...
export default function Page() {
	...
	return (
		<div className="bg-white">
			<div>
				<p className={`${montserrat.className} text-center text-2xl font-bold mb-2 mt-4`}>
					Your Curated Meals:
				</p>
			</div>
			...
			{breakfast && (
				<div className="bg-[#E8F5E9] p-4 rounded-md shadow mb-4 mx-10">
					<p className={`${jost.className} text-center text-2xl font-bold mb-2`}>
						Breakfast:
					</p>
					<div className="flex flex-row justify-evenly gap-4">
						{breakfastList.map((meal, index) => (
							<Card key={`breakfast-${index}`} className="h-[400px] w-[400px] bg-white">
								<CardHeader>
				...
				<div className="bg-[#C7E6C9] p-4 rounded-md shadow mb-4 mx-10">
					...
					<div className="flex flex-row justify-evenly gap-4">
						{lunchList.map((meal, index) => (
							<Card key={`lunch-${index}`} className="h-[400px] w-[400px] bg-white">
								<CardHeader>
									<div className="flex items-center justify-between">
										<CardTitle className={montserrat.className}>
											{meal.name || `Breakfast Meal ${index + 1}`}
				...
				<div className="bg-[#ABD9AE] p-4 rounded-md shadow mb-4 mx-10">
					...
					<div className="flex flex-row justify-evenly gap-4">
						{dinnerList.map((meal, index) => (
							<Card key={`dinner-${index}`} className="h-[400px] w-[400px] bg-white">
								<CardHeader>
									<div className="flex items-center justify-between">
										<CardTitle className={montserrat.className}>
